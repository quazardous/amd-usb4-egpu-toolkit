...
Validated on a **Lenovo ThinkPad T14s Gen 5** (AMD Ryzen 7 PRO 8840HS, Hawk Point) + Razer Core X V2 (USB4) + NVIDIA RTX 3090.
...
Reference numbers on **USB4 + RTX 3090 + AMD Ryzen 7 PRO 8840HS (Hawk Point), ThinkPad T14s Gen 5**:
...
Curated links that informed the diagnosis and design of this toolkit. Not exhaustive — see the linked discussion threads for follow-on context.

### NVIDIA official documentation

- [Xid Errors — analyzing the catalog](https://docs.nvidia.com/deploy/xid-errors/analyzing-xid-catalog.html) — canonical reference for Xid 79 and the other GPU error codes
